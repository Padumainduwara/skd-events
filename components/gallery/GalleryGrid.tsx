          ...
          <AnimatePresence>
            {filteredImages.map((item) => (
              <motion.div
                ...
                className="relative break-inside-avoid rounded-3xl overflow-hidden group cursor-pointer shadow-md hover:shadow-2xl transition-all duration-500 bg-gray-100 transform-gpu will-change-transform"
              >
                {/* Image */}
                <img 
                  src={item.src} 
                  ...
                  decoding="async" 
                  loading="lazy" 
                  className="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-[800ms]"
                />
