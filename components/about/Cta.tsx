...
export default function Cta() {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-gray-100 via-white to-white z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="relative w-full rounded-[2.5rem] md:rounded-[3rem] overflow-hidden bg-[#050505] shadow-[0_20px_60px_-15px_rgba(164,0,73,0.4)] group"
        >
          ...
          <motion.div 
            ...
            className="absolute top-[-20%] right-[-10%] w-[50vw] md:w-[30vw] h-[50vw] md:h-[30vw] bg-[#ff4d94] rounded-full blur-[120px] mix-blend-screen pointer-events-none" 
          />
          <motion.div 
            animate={{ 
              scale: [1, 1.5, 1],
            ...
            className="absolute bottom-[-20%] left-[-10%] w-[60vw] md:w-[40vw] h-[60vw] md:h-[40vw] bg-[#a40049] rounded-full blur-[140px] pointer-events-none" 
          />
          ...
          <div className="relative z-20 px-6 py-16 md:py-24 lg:px-20 flex flex-col items-center text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/10 border border-white/20 mb-8 backdrop-blur-md"
            >
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white tracking-tight mb-6 leading-tight max-w-4xl"
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-gray-300 max-w-2xl mb-12 font-medium leading-relaxed"
            >
            ...
            <motion.div 
              ...
              className="mt-16 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 pt-8 border-t border-white/10 w-full max-w-3xl"
            >
